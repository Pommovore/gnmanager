# Règles et Conventions du Projet GN Manager
...
### Backend
*   **Structure Modulaire** : Utiliser les **Blueprints** Flask pour organiser les routes par domaine fonctionnel (ex: `routes/auth_routes.py`, `routes/event_routes.py`).
...
*   **Sécurité** :
    *   Utiliser les décorateurs `@login_required` et `@organizer_required`.
